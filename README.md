...
Projeto desenvolvido durante o Curso de Desenvolvimento WEB, Turma 12, da [trybe](https://www.betrybe.com/), onde desenvolvi minhas habilidades em JavaScript, HTML e CSS, na criação de uma página de formulário.

Obs.: O Projeto foi desenvolvido em dupla. 

Minha dupla no Projeto: [Max Alves](https://github.com/MaxAlves0035) 
...
- Versionamento de código em dupla.
